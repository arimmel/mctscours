...
\frame{
  ...
  \begin{center}
      ...
      \only<4> { \includegraphics[width=0.4\textwidth]{figs/gorule4.png} }
  \end{center}
...
\frame{
  ...
  \begin{center}
      ...
      \only<2> { \includegraphics[width=0.4\textwidth]{figs/gorule_string2.png} }%
      \only<3> { \includegraphics[width=0.4\textwidth]{figs/gorule_string3.png} }%
      \only<4> { \includegraphics[width=0.4\textwidth]{figs/gorule_string4.png} }%
...
\frame{
  ...
  \begin{center}
      ...
      \only<2> { \includegraphics[width=0.4\textwidth]{figs/gorule_capture2.png} }%
      \only<3> { \includegraphics[width=0.4\textwidth]{figs/gorule_capture3.png} }%
...
\frame{
  ...
  \begin{center}
      \only<1> { \includegraphics[width=0.4\textwidth]{figs/gorule_score1.png} }%
      \only<2> { \includegraphics[width=0.4\textwidth]{figs/gorule_score2.png} }%
      \only<3> { \includegraphics[width=0.4\textwidth]{figs/gorule_score3.png} }%
      \only<4> { \includegraphics[width=0.4\textwidth]{figs/gorule_score4.png} }%
      \only<5> { \includegraphics[width=0.4\textwidth]{figs/gorule_score5.png} }
  \end{center}
...
\end{tikzpicture}
TODO evaluation/descente sur derniere image
}
